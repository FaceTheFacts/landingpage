    ...
    <HomeHeaderFooter>
      <div className="about-us-content">
        ...
        <div className="about-us-sentences">
          ...
          <p>
            Wir stehen weltweit vor unglaublichen Herausforderungen und brauchen
            gerade die besten Politiker:innen, die wir kriegen können.
          </p>
          <p>
            Deshalb reicht es nicht mehr, einfach nur nach Parteien und deren
            Wahlversprechen zu wählen, sondern wir müssen uns auch genauer
            anschauen, wer denn am Ende wirklich im Parlamenten sitzt.
            <br />
            Welche Kompetenzen haben diese Menschen, welche Positionen vertreten
            sie und wer oder was könnte sie beeinflussen?
          </p>
          <p>
            Mit Face the Facts kannst du das jetzt einfach über die Handykamera
            direkt am Wahlplakat herausfinden und so schnell die besten
            Kandidat:innen für dich finden.
          </p>
          <p>
            Die Daten stammen alle aus frei verfügbaren Quellen wie Wikipedia,
            Abgeordnetenwatch oder direkt den Seiten der Parlamente.
            <br /> Wir tragen sie nur zusammen und bereiten sie besser auf. Wie
            wir das genau machen, kannst du dir unter{" "}
